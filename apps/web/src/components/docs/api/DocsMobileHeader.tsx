...
import { MenuIcon, SearchIcon, XIcon } from "@/components/docs/shared/icons";
...
export function DocsMobileHeader({
  ...
  const heading = title ?? ui.apiReference;
  ...
  return (
    <>
      ...
      >
        <a href={logoHref} className="inline-flex items-center gap-2.5 font-semibold">
          <BrandLogo size="nav" />
        </a>
      ...
      >
        <span className="font-medium text-[#0a0a0a]">{heading}</span>
      </header>
