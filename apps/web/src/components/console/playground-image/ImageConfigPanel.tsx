...
import { InfoCircleIcon, SyncIcon } from "./icons";
...
export function ImageConfigPanel({
  ...
  return (
    <div className="flex h-full w-[300px] min-w-[300px] flex-col gap-3 pr-5">
      ...
      <div className="model-form">
        <div className="mb-3">
          ...
          <div className="flex max-w-full">
            {IMAGE_SIZES.map((ratio, index) => {
              const checked = size === ratio;
              const isFirst = index === 0;
              const isLast = index === IMAGE_SIZES.length - 1;
              return (
                <button
                  key={ratio}
                  type="button"
